    ...
    <div class="form-conatiner d-flex justify-content-center mt-5">
        ...
        ?>
            <div class="mb-3">
              ...
              <input type="text" class="form-control" placeholder="Name" name="name" value="<?php echo $rowdata['name']?>">
              </div>
              <div class="mb-3">
              <label class="form-label">Password</label>
              <input type="text" class="form-control" placeholder="Password" name="password" value="<?php echo $rowdata['password'] ?>">
            </div>
            <input type="submit" class="btn btn-dark" name="updated" value="Update">
          </form>
    </div>
